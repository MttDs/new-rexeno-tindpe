...
public:
	...
	// ====================================================================
	CVector3(scalar_t X, scalar_t Y, scalar_t Z) 
	{ 
		x = X; y = Y; z = Z;
	}
	...
	// ===================================================================================
	CVector3 operator*(scalar_t num)
	{
	...
	// =================================================================
	const scalar_t operator%(const CVector3& vVector) const
	{
	...
	// =====================
	static scalar_t Length(CVector3 vNormal)
	{
		// length = sqrt(V.x^2 + V.y^2 + V.z^2)  V est le vecteur
		return (scalar_t)sqrt((vNormal.x * vNormal.x) + (vNormal.y * vNormal.y) + (vNormal.z * vNormal.z));
	}
...
public:
	...
	// Constructeur permetant de creer un vecteur avec des valeurs definies
	// ====================================================================
	CVector2(scalar_t X, scalar_t Y) 
	{ 
		x = X; y = Y;
	}
};
