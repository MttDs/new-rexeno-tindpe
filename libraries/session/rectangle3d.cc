			 ...
			 Trial* father)
{
  ...
  vm.addVariable(_deep = new Variable(si.attributes[10]));
  vm.addVariable(_velo = new Variable(si.attributes[11]));
  vm.addVariable(_repeat = new Variable(si.attributes[12]));
  vm.addVariable(_dir = new Variable(si.attributes[13]));
  vm.addVariable(_pos = new Variable(si.attributes[14]));
